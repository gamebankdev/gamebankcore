...
#ifdef _WIN32
#define __VERSION__	"windows_win32"
#endif
...
// _segment is  unique_ptr<bip::managed_mapped_file>                        
//  _meta   is  unique_ptr<bip::managed_mapped_file>                       
   void database::flush() {
#ifndef ENABLE_STD_ALLOCATOR
      if( _segment )
         _segment->flush();		//managed_mapped_file::flush
      if( _meta )
         _meta->flush();		//managed_mapped_file::flush
#endif
   }
