...
bool application::initialize_impl(int argc, char** argv, vector<abstract_plugin*> autostart_plugins)
{
   try
   {
      ...
      else
      {
         ...
         #pragma message( "TODO: Remove this check for Gamebank release 0.20.1+" )
...
void application::exec() {
    ...
    *  Useful for usecase: `gamebankd | tee gamebankd.log` and pressing Ctrl+C
    **/
#ifndef _WIN32
   signal(SIGPIPE, SIG_IGN);
#else
	SetConsoleCtrlHandler([](DWORD type)->BOOL {raise(SIGINT); return TRUE; }, TRUE);
#endif
