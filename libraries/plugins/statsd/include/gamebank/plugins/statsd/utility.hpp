#pragma once
#include <gamebank/plugins/statsd/statsd_plugin.hpp>
...
using gamebank::plugins::statsd::statsd_plugin;
...
if( gamebank::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   gamebank::plugins::statsd::util::get_statsd().increment( \
...
if( gamebank::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   gamebank::plugins::statsd::util::get_statsd().decrement( \
      #NAMESPACE, #STAT, #KEY, FREQ                      \
   );                                                    \
}
...
if( gamebank::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   gamebank::plugins::statsd::util::get_statsd().count(     \
...
if( gamebank::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   gamebank::plugins::statsd::util::get_statsd().gauge(     \
      #NAMESPACE, #STAT, #KEY, VAL, FREQ                 \
   );                                                    \
}

#define STATSD_START_TIMER( NAMESPACE, STAT, KEY, FREQ )                                              \
fc::optional< gamebank::plugins::statsd::util::statsd_timer_helper > NAMESPACE ## STAT ## KEY ## _timer; \
if( gamebank::plugins::statsd::util::statsd_enabled() )                                                  \
{                                                                                                     \
   NAMESPACE ## STAT ## KEY ## _timer = gamebank::plugins::statsd::util::statsd_timer_helper(            \
      #NAMESPACE, #STAT, #KEY, FREQ, gamebank::plugins::statsd::util::get_statsd()                       \
   );                                                                                                 \
}
...
if( gamebank::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   gamebank::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      gamebank::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
