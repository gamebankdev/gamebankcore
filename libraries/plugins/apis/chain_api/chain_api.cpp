#include <gamebank/plugins/chain_api/chain_api_plugin.hpp>
#include <gamebank/plugins/chain_api/chain_api.hpp>
...
{
   JSON_RPC_REGISTER_API( GAMEBANK_CHAIN_API_PLUGIN_NAME );
}
