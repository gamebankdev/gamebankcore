#include <gamebank/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <gamebank/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > GAMEBANK_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( GAMEBANK_DEBUG_NODE_API_PLUGIN_NAME );
}
