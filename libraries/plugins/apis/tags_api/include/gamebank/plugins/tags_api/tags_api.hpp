...
{
   discussion( const gamebank::chain::comment_object& o, const gamebank::chain::database& db ) :
   ...
   string                        root_title;
   asset                         pending_payout_value; ///< gbd
   asset                         total_pending_payout_value; ///< gbd including replies
   vector< vote_state >          active_votes;
   vector< string >              replies; ///< author/slug mapping
   share_type                    author_reputation = 0;
   asset                         promoted = asset(0, GBD_SYMBOL);
...
FC_REFLECT( gamebank::plugins::tags::api_tag_object,
            (name)(total_payouts)(net_votes)(top_posts)(comments)(trending) )

FC_REFLECT( gamebank::plugins::tags::vote_state,
...
FC_REFLECT( gamebank::plugins::tags::get_trending_tags_return,
            (tags) )

FC_REFLECT( gamebank::plugins::tags::get_tags_used_by_author_args,
            (author) )

FC_REFLECT( gamebank::plugins::tags::tag_count_object,
            (tag)(count) )

FC_REFLECT( gamebank::plugins::tags::get_tags_used_by_author_return,
            (tags) )

FC_REFLECT( gamebank::plugins::tags::get_discussion_args,
            (author)(permlink) )

FC_REFLECT( gamebank::plugins::tags::discussion_query,
...
FC_REFLECT( gamebank::plugins::tags::get_discussions_by_author_before_date_args,
            (author)(start_permlink)(before_date)(limit) )

FC_REFLECT( gamebank::plugins::tags::get_active_votes_return,
            (votes) )
