...
#include <gamebank/plugins/condenser_api/condenser_api_legacy_asset.hpp>
...
namespace gamebank { namespace plugins { namespace condenser_api {
   ...
   typedef nonfungible_fund_create_operation	  legacy_nonfungible_fund_create_operation;
   ...
   struct api_chain_properties
   {
      ...
      api_chain_properties( const chain::chain_properties& c ) :
         ...
         gbd_interest_rate( c.gbd_interest_rate )
      {}

      operator legacy_chain_properties() const
      {
         legacy_chain_properties props;
         props.account_creation_fee = legacy_gamebank_asset::from_asset( asset( account_creation_fee ) );
         props.maximum_block_size = maximum_block_size;
         props.gbd_interest_rate = gbd_interest_rate;
         return props;
      }
   ...
   struct legacy_comment_options_operation
   {
      ...
      operator comment_options_operation()const
      {
         ...
         op.percent_gamebank_dollars = percent_gamebank_dollars;
      ...
      uint16_t          percent_gamebank_dollars;
      bool              allow_votes;
   ...
   struct legacy_escrow_transfer_operation
   {
      ...
      legacy_escrow_transfer_operation( const escrow_transfer_operation& op ) :
         ...
         gbd_amount( legacy_asset::from_asset( op.gbd_amount ) ),
         gbc_amount( legacy_asset::from_asset( op.gbc_amount ) ),
         fee( legacy_asset::from_asset( op.fee ) ),
      ...
      operator escrow_transfer_operation()const
      {
         ...
         op.gbd_amount = gbd_amount;
         op.gbc_amount = gbc_amount;
         op.fee = fee;
      ...
      legacy_asset      gbd_amount;
      legacy_asset      gbc_amount;
      legacy_asset      fee;
   ...
   struct legacy_pow2_operation
   {
         ...
         new_owner_key( op.new_owner_key )
      {
         ...
         props.gbd_interest_rate = op.props.gbd_interest_rate;
      }
      ...
      operator pow2_operation()const
      {
         ...
         op.props.account_creation_fee = legacy_gamebank_asset::from_asset( asset( props.account_creation_fee ) );
         op.props.maximum_block_size = props.maximum_block_size;
         op.props.gbd_interest_rate = props.gbd_interest_rate;
         return op;
      }
   ...
   struct legacy_claim_reward_balance_operation
   {
      ...
      legacy_claim_reward_balance_operation( const claim_reward_balance_operation& op ) :
         account( op.account ),
         reward_gbc( legacy_asset::from_asset( op.reward_gbc ) ),
         reward_gbd( legacy_asset::from_asset( op.reward_gbd ) ),
      ...
      operator claim_reward_balance_operation()const
      {
         ...
         op.account = account;
         op.reward_gbc = reward_gbc;
         op.reward_gbd = reward_gbd;
         op.reward_vests = reward_vests;
         return op;
      }

      account_name_type account;
      legacy_asset      reward_gbc;
      legacy_asset      reward_gbd;
   ...
   struct legacy_author_reward_operation
   {
      ...
      legacy_author_reward_operation( const author_reward_operation& op ) :
         author( op.author ),
         permlink( op.permlink ),
         gbd_payout( legacy_asset::from_asset( op.gbd_payout ) ),
         gbc_payout( legacy_asset::from_asset( op.gbc_payout ) ),
      ...
      operator author_reward_operation()const
      {
         ...
         op.author = author;
         op.permlink = permlink;
         op.gbd_payout = gbd_payout;
         op.gbc_payout = gbc_payout;
      ...
      account_name_type author;
      string            permlink;
      legacy_asset      gbd_payout;
      legacy_asset      gbc_payout;
   ...
   struct legacy_crowdfunding_operation
   {
       legacy_crowdfunding_operation() {}
       legacy_crowdfunding_operation(const crowdfunding_operation& op) :
           originator( op.originator ), 
           permlink( op.permlink ),
           raise( legacy_asset::from_asset( op.raise ) ),
           title( op.title ),
           body( op.body ),
           json_metadata( op.json_metadata )
       {}
       operator crowdfunding_operation()const
       {
   ...
   struct legacy_invest_operation
   {
       legacy_invest_operation() {}
       legacy_invest_operation(const invest_operation& op) :
           invester( op.invester ), 
           originator( op.originator ), 
           permlink( op.permlink ),
           raise( legacy_asset::from_asset( op.raise ) )
       {}
       operator invest_operation()const
       {
           invest_operation op;
   ...
   typedef fc::static_variant<
            ...
            legacy_crowdfunding_operation,
            legacy_invest_operation,
		    legacy_nonfungible_fund_create_operation,
   ...
   struct legacy_operation_conversion_visitor
   {
	  ...
	  bool operator()(const nonfungible_fund_create_operation& op)const          { l_op = op; return true; }
      ...
      bool operator()(const crowdfunding_operation& op)const
      {
          l_op = legacy_crowdfunding_operation(op);
          return true;
      }

      bool operator()(const invest_operation& op)const
      {
          l_op = legacy_invest_operation(op);
          return true;
      }
...
struct convert_from_legacy_operation_visitor
{
   ...
   operation operator()(const legacy_crowdfunding_operation& op)const
   {
       return operation(crowdfunding_operation(op));
   }

   operation operator()(const legacy_invest_operation& op)const
   {
       return operation(invest_operation(op));
   }
...
void to_variant( const gamebank::plugins::condenser_api::legacy_operation&, fc::variant& );
void from_variant( const fc::variant&, gamebank::plugins::condenser_api::legacy_operation& );

void to_variant( const gamebank::plugins::condenser_api::legacy_comment_options_extensions&, fc::variant& );
void from_variant( const fc::variant&, gamebank::plugins::condenser_api::legacy_comment_options_extensions& );

void to_variant( const gamebank::plugins::condenser_api::legacy_pow2_work&, fc::variant& );
void from_variant( const fc::variant&, gamebank::plugins::condenser_api::legacy_pow2_work& );
...
FC_REFLECT( gamebank::plugins::condenser_api::api_chain_properties,
            (account_creation_fee)(maximum_block_size)(gbd_interest_rate)
          )

FC_REFLECT( gamebank::plugins::condenser_api::legacy_price, (base)(quote) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_feed_publish_operation, (publisher)(exchange_rate) )

FC_REFLECT( gamebank::plugins::condenser_api::legacy_account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( gamebank::plugins::condenser_api::legacy_account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( gamebank::plugins::condenser_api::legacy_transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_gamebank_dollars)(allow_votes)(allow_curation_rewards)(extensions) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_escrow_transfer_operation, (from)(to)(gbd_amount)(gbc_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( gamebank::plugins::condenser_api::legacy_escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(gbd_amount)(gbc_amount) );
FC_REFLECT( gamebank::plugins::condenser_api::legacy_pow2_operation, (work)(new_owner_key)(props) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_claim_reward_balance_operation, (account)(reward_gbc)(reward_gbd)(reward_vests) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
FC_REFLECT( gamebank::plugins::condenser_api::legacy_author_reward_operation, (author)(permlink)(gbd_payout)(gbc_payout)(vesting_payout) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_interest_operation, (owner)(interest) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_return_vesting_delegation_operation, (account)(vesting_shares) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_comment_benefactor_reward_operation, (benefactor)(author)(permlink)(reward) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_producer_reward_operation, (producer)(vesting_shares) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_claim_account_operation, (creator)(fee)(extensions) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_crowdfunding_operation, (originator)(permlink)(raise)(title)(body)(json_metadata) )
FC_REFLECT( gamebank::plugins::condenser_api::legacy_invest_operation, (invester)(originator)(permlink)(raise) )

FC_REFLECT_TYPENAME( gamebank::plugins::condenser_api::legacy_operation )
