...
#include <gamebank/plugins/database_api/database_api.hpp>
#include <gamebank/plugins/block_api/block_api.hpp>
#include <gamebank/plugins/account_history_api/account_history_api.hpp>
#include <gamebank/plugins/account_by_key_api/account_by_key_api.hpp>
#include <gamebank/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <gamebank/plugins/tags_api/tags_api.hpp>
#include <gamebank/plugins/follow_api/follow_api.hpp>
#include <gamebank/plugins/reputation_api/reputation_api.hpp>
#include <gamebank/plugins/market_history_api/market_history_api.hpp>
#include <gamebank/plugins/witness_api/witness_api.hpp>

#include <gamebank/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      gbd_balance( legacy_asset::from_asset( a.gbd_balance ) ),
      gbd_seconds( a.gbd_seconds ),
      gbd_seconds_last_update( a.gbd_seconds_last_update ),
      gbd_last_interest_payment( a.gbd_last_interest_payment ),
      savings_gbd_balance( legacy_asset::from_asset( a.savings_gbd_balance ) ),
      savings_gbd_seconds( a.savings_gbd_seconds ),
      savings_gbd_seconds_last_update( a.savings_gbd_seconds_last_update ),
      savings_gbd_last_interest_payment( a.savings_gbd_last_interest_payment ),
      savings_withdraw_requests( a.savings_withdraw_requests ),
      reward_gbd_balance( legacy_asset::from_asset( a.reward_gbd_balance ) ),
      reward_gbc_balance( legacy_asset::from_asset( a.reward_gbc_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_gbc( legacy_asset::from_asset( a.reward_vesting_gbc ) ),
   ...
   legacy_asset      gbd_balance;
   uint128_t         gbd_seconds;
   time_point_sec    gbd_seconds_last_update;
   time_point_sec    gbd_last_interest_payment;

   legacy_asset      savings_gbd_balance;
   uint128_t         savings_gbd_seconds;
   time_point_sec    savings_gbd_seconds_last_update;
   time_point_sec    savings_gbd_last_interest_payment;

   uint8_t           savings_withdraw_requests = 0;

   legacy_asset      reward_gbd_balance;
   legacy_asset      reward_gbc_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_gbc;
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_gamebank_dollars( c.percent_gamebank_dollars ),
   ...
   uint16_t          percent_gamebank_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      current_gbd_supply( legacy_asset::from_asset( o.current_gbd_supply ) ),
      confidential_gbd_supply( legacy_asset::from_asset( o.confidential_gbd_supply ) ),
      total_vesting_fund_gbc( legacy_asset::from_asset( o.total_vesting_fund_gbc ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_gbc( legacy_asset::from_asset( o.total_reward_fund_gbc ) ),
      ...
      pending_rewarded_vesting_gbc( legacy_asset::from_asset( o.pending_rewarded_vesting_gbc ) ),
      gbd_interest_rate( o.gbd_interest_rate ),
      gbd_print_rate( o.gbd_print_rate ),
   ...
   legacy_asset      current_gbd_supply;
   legacy_asset      confidential_gbd_supply;
   legacy_asset      total_vesting_fund_gbc;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_gbc;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_gbc;
...
struct api_witness_object
{
   ...
   api_witness_object( const database_api::api_witness_object& w ) :
      ...
      props( w.props ),
      gbd_exchange_rate( w.gbd_exchange_rate ),
      last_gbd_exchange_update( w.last_gbd_exchange_update ),
      votes( w.votes ),
   ...
   legacy_price            gbd_exchange_rate;
   ...
   time_point_sec          hardfork_time_vote = GAMEBANK_GENESIS_TIME;
};
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      gbd_balance( legacy_asset::from_asset( e.gbd_balance ) ),
      gbc_balance( legacy_asset::from_asset( e.gbc_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), gamebank_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string gamebank_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      gbc_volume( legacy_asset::from_asset( t.gbc_volume ) ),
      gbd_volume( legacy_asset::from_asset( t.gbd_volume ) )
   {}
   ...
   legacy_asset   gbc_volume;
   legacy_asset   gbd_volume;
};
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      gbc_volume( legacy_asset::from_asset( v.gbc_volume ) ),
      gbd_volume( legacy_asset::from_asset( v.gbd_volume ) )
   {}
...
struct api_nonfungible_fund_object
{
	api_nonfungible_fund_object(const nonfungible_fund_object& o) :
		fund_id( o.id ),
		creator( o.creator ),
		owner( o.owner ),
		metadata( to_string(o.meta_data) ),
		last_update( o.last_update ),
		created( o.created )
	{}
	api_nonfungible_fund_object() {}
...
struct api_nonfungible_fund_on_sale_object
{
      api_nonfungible_fund_on_sale_object( const nonfungible_fund_on_sale_object& o ) :
        id( o.id ), 
        fund_id( o.fund_id ), 
        created( o.created ), 
        expiration( o.expiration ), 
        seller( o.seller ), 
        selling_price( legacy_asset::from_asset( o.selling_price ) )
      {}

      api_nonfungible_fund_on_sale_object(){}
...
DEFINE_API_ARGS( get_contract,                           vector< variant >,   optional< legacy_signed_contract > )
...
public:
   ...
   DECLARE_API(
	  ...
	  (get_nonfungible_funds)
	  (get_nonfungible_funds_on_sale_by_seller)
...
FC_REFLECT( gamebank::plugins::condenser_api::discussion_index,
...
FC_REFLECT( gamebank::plugins::condenser_api::api_tag_object,
...
FC_REFLECT( gamebank::plugins::condenser_api::api_operation_object,
             (trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(op) )

FC_REFLECT( gamebank::plugins::condenser_api::api_account_object,
             ...
             (reward_gbd_balance)(reward_gbc_balance)(reward_vesting_balance)(reward_vesting_gbc)
...
FC_REFLECT( gamebank::plugins::condenser_api::api_comment_object,
             ...
             (max_accepted_payout)(percent_gamebank_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( gamebank::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(current_gbd_supply)(confidential_gbd_supply)
            (total_vesting_fund_gbc)(total_vesting_shares)
            (total_reward_fund_gbc)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_gbc)
            (gbd_interest_rate)(gbd_print_rate)
...
FC_REFLECT( gamebank::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
             ...
             (props)
             (gbd_exchange_rate)(last_gbd_exchange_update)
             (last_work)
             (running_version)
             (hardfork_version_vote)(hardfork_time_vote)
          )

FC_REFLECT( gamebank::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( gamebank::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( gamebank::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( gamebank::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (gbd_balance)(gbc_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( gamebank::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( gamebank::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( gamebank::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( gamebank::plugins::condenser_api::api_convert_request_object,
...
FC_REFLECT( gamebank::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( gamebank::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( gamebank::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( gamebank::plugins::condenser_api::get_version_return,
...
FC_REFLECT( gamebank::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( gamebank::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(gbc_volume)(gbd_volume) )

FC_REFLECT( gamebank::plugins::condenser_api::volume,
            (gbc_volume)(gbd_volume) )

FC_REFLECT( gamebank::plugins::condenser_api::order,
            (order_price)(real_price)(gbc)(gbd)(created) )

FC_REFLECT( gamebank::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( gamebank::plugins::condenser_api::market_trade,
            (date)(current_pays)(open_pays) )

FC_REFLECT( gamebank::plugins::condenser_api::api_nonfungible_fund_object,
		    (fund_id)(creator)(owner)(metadata)(last_update)(created) )
