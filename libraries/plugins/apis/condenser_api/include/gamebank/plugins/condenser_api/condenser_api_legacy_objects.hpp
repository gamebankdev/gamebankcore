...
void to_variant( const gamebank::plugins::condenser_api::legacy_block_header_extensions&, fc::variant& );
void from_variant( const fc::variant&, gamebank::plugins::condenser_api::legacy_block_header_extensions& );

}

FC_REFLECT( gamebank::plugins::condenser_api::legacy_signed_transaction,
