...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_gamebank_dollars( o.percent_gamebank_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      savings_gbd_balance( a.savings_gbd_balance ),
      ...
      reward_gbd_balance( a.reward_gbd_balance ),
      reward_gbc_balance( a.reward_gbc_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_gbc( a.reward_vesting_gbc ),
   ...
   asset             reward_gbd_balance;
   asset             reward_gbc_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_gbc;
...
{
   price                order_price;
   double               real_price; // dollars per gbc
   share_type           gbc;
   share_type           gbd;
...
FC_REFLECT( gamebank::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( gamebank::plugins::database_api::api_account_object,
...
FC_REFLECT( gamebank::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( gamebank::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( gamebank::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( gamebank::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( gamebank::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( gamebank::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( gamebank::plugins::database_api::api_signed_block_object, (gamebank::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( gamebank::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( gamebank::plugins::database_api::order, (order_price)(real_price)(gbc)(gbd)(created) );

FC_REFLECT( gamebank::plugins::database_api::order_book, (asks)(bids) );
