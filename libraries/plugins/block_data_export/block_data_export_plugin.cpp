...
namespace gamebank { namespace plugins { namespace block_data_export {
...
FC_REFLECT( gamebank::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace gamebank { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // gamebank::plugins::block_data_export
