...
#define GAMEBANK_WEBSERVER_PLUGIN_NAME "webserver"

namespace gamebank { namespace plugins { namespace webserver {
...
class webserver_plugin : public appbase::plugin< webserver_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = GAMEBANK_WEBSERVER_PLUGIN_NAME; return name; }
