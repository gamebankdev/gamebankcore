...
FC_REFLECT( gamebank::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::block_summary_object, gamebank::chain::block_summary_index )
