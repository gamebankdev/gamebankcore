...
namespace gamebank { namespace chain {
   ...
   using gamebank::protocol::digest_type;
   using gamebank::protocol::public_key_type;
   using gamebank::protocol::version;
   using gamebank::protocol::hardfork_version;
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( GAMEBANK_MIN_ACCOUNT_CREATION_FEE, GBC_SYMBOL );
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Gamebank blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, GAMEBANK_MAX_WITNESSES >             current_shuffled_witnesses;
...
FC_REFLECT_ENUM( gamebank::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( gamebank::chain::chain_properties,
...
FC_REFLECT( gamebank::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::witness_object, gamebank::chain::witness_index )

FC_REFLECT( gamebank::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::witness_vote_object, gamebank::chain::witness_vote_index )

FC_REFLECT( gamebank::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::witness_schedule_object, gamebank::chain::witness_schedule_index )
