...
#include <gamebank/schema/schema.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< gamebank::schema::abstract_schema > get_operation_schema() override
      {
         return gamebank::schema::get_schema_for_type< CustomOperationType >();
      }
};
