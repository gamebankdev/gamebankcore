...
FC_REFLECT( gamebank::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::transaction_object, gamebank::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<gamebank::chain::transaction_index>
   {
   public:
      typedef gamebank::chain::transaction_index IndexType;
      typedef typename gamebank::chain::transaction_object::t_packed_trx t_packed_trx;
