...
namespace gamebank { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert gbd to gbc
    */
    ...
    *  1000 GBC or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         int64_t           gbc_volume = 0;
         int64_t           gbd_volume = 0;
         uint128_t         weight = 0;
         ...
         {
            return gbc_volume * gbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(gbc_volume,gbd_volume) * is_positive();
         }
         ...
         {
            return ( gbc_volume > 0 && gbd_volume > 0 ) ? 1 : 0;
         }
   };
...
#include <gamebank/chain/crowdfunding_object.hpp>
...
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::limit_order_object, gamebank::chain::limit_order_index )

FC_REFLECT( gamebank::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::feed_history_object, gamebank::chain::feed_history_index )

FC_REFLECT( gamebank::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::convert_request_object, gamebank::chain::convert_request_index )

FC_REFLECT( gamebank::chain::liquidity_reward_balance_object,
             (id)(owner)(gbc_volume)(gbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::liquidity_reward_balance_object, gamebank::chain::liquidity_reward_balance_index )

FC_REFLECT( gamebank::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::withdraw_vesting_route_object, gamebank::chain::withdraw_vesting_route_index )

FC_REFLECT( gamebank::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::savings_withdraw_object, gamebank::chain::savings_withdraw_index )

FC_REFLECT( gamebank::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (gbd_balance)(gbc_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::escrow_object, gamebank::chain::escrow_index )

FC_REFLECT( gamebank::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::decline_voting_rights_request_object, gamebank::chain::decline_voting_rights_request_index )

FC_REFLECT( gamebank::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::reward_fund_object, gamebank::chain::reward_fund_index )
