...
namespace gamebank { namespace chain {
   ...
   using gamebank::protocol::weight_type;
...
FC_REFLECT_TYPENAME( gamebank::chain::shared_authority::account_authority_map)
FC_REFLECT( gamebank::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
