...
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::comment_object, gamebank::chain::comment_index )

FC_REFLECT( gamebank::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::comment_content_object, gamebank::chain::comment_content_index )

FC_REFLECT( gamebank::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( gamebank::chain::comment_vote_object, gamebank::chain::comment_vote_index )
...
namespace helpers
{
   ...
   template <>
   class index_statistic_provider<gamebank::chain::comment_index>
   {
   public:
      typedef gamebank::chain::comment_index IndexType;
      typedef typename gamebank::chain::comment_object::t_beneficiaries t_beneficiaries;
   ...
   template <>
   class index_statistic_provider<gamebank::chain::comment_content_index>
   {
   public:
      typedef gamebank::chain::comment_content_index IndexType;
