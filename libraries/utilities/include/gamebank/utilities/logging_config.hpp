...
FC_REFLECT( gamebank::utilities::console_appender_args, (appender)(stream) )
FC_REFLECT( gamebank::utilities::file_appender_args, (appender)(file) )
FC_REFLECT( gamebank::utilities::logger_args, (name)(level)(appender) )
