...
optional< condenser_api::legacy_signed_contract > remote_node_api::get_contract(uint32_t)
{
    FC_ASSERT(false);
}
...
vector< condenser_api::api_nonfungible_fund_object > remote_node_api::get_nonfungible_funds(account_name_type)
{
	FC_ASSERT(false);
}

vector< condenser_api::api_nonfungible_fund_on_sale_object > remote_node_api::get_nonfungible_funds_on_sale_by_seller(account_name_type)
{
    FC_ASSERT(false);
}

vector< condenser_api::api_nonfungible_fund_on_sale_object > remote_node_api::get_nonfungible_fund_on_sale_by_fund_id(int64_t)
{
    FC_ASSERT(false);
}
