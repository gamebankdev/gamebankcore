 ...
 * - Length is between (inclusive) GAMEBANK_MIN_ACCOUNT_NAME_LENGTH and GAMEBANK_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace gamebank::protocol


FC_REFLECT_TYPENAME( gamebank::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( gamebank::protocol::authority::key_authority_map)
FC_REFLECT( gamebank::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( gamebank::protocol::authority::classification, (owner)(active)(key)(posting) )
