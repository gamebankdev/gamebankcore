...
/*
 * This class represents the basic versioning scheme of the Gamebank blockchain.
...
{
   class variant;
   void to_variant( const gamebank::protocol::version& v, variant& var );
   void from_variant( const variant& var, gamebank::protocol::version& v );

   void to_variant( const gamebank::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, gamebank::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( gamebank::protocol::version, (v_num) )
FC_REFLECT_DERIVED( gamebank::protocol::hardfork_version, (gamebank::protocol::version), )

FC_REFLECT( gamebank::protocol::hardfork_version_vote, (hf_version)(hf_time) )
