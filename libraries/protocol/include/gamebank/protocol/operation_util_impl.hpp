...
//
// Place GAMEBANK_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define GAMEBANK_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace gamebank { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( gamebank::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( gamebank::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* gamebank::protocol */
