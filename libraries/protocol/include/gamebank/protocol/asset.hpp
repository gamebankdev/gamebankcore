...
namespace gamebank { namespace protocol {
   ...
   /** Represents quotation of the relative value of asset against another asset.
       ...
       1.25 USD is an asset specified as a qute
...
FC_REFLECT( gamebank::protocol::asset, (amount)(symbol) )
FC_REFLECT( gamebank::protocol::price, (base)(quote) )
