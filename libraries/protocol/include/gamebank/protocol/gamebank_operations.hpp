...
#include <gamebank/protocol/validation.hpp>
#include <gamebank/protocol/legacy_asset.hpp>
...
namespace gamebank { namespace protocol {
    ...
    *  The percent_gamebank_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      asset             max_accepted_payout    = asset( 1000000000, GBD_SYMBOL );       /// GBD value of the maximum payout this post will receive
      uint16_t          percent_gamebank_dollars  = GAMEBANK_100_PERCENT; /// the percent of Gamebank Dollars to key, unkept amounts will be received as Gamebank Power
    ...
    * @ingroup operations
    *
    * @brief Transfers GBC from one account to another.
    */
   struct transfer_operation : public base_operation
   {
      ...
      void              validate()const;
      void get_required_active_authorities( flat_set<account_name_type>& a )const{ if(amount.symbol != GBS_SYMBOL) a.insert(from); }
      void get_required_owner_authorities( flat_set<account_name_type>& a )const { if(amount.symbol == GBS_SYMBOL) a.insert(from); }
   };
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             gbd_amount = asset( 0, GBD_SYMBOL );
      asset             gbc_amount = asset( 0, GBC_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      uint32_t          escrow_id = 30;
      asset             gbd_amount = asset( 0, GBD_SYMBOL ); ///< the amount of gbd to release
      asset             gbc_amount = asset( 0, GBC_SYMBOL ); ///< the amount of gbc to release
   ...
   /**
    *  This operation converts liquid token (GBC) into VFS (Vesting Fund Shares,
    *  GBS) at the current exchange rate. With this operation it is possible to
    ...
    * vests to gbc and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in GBC, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      legacy_gamebank_asset account_creation_fee = legacy_gamebank_asset::from_amount( GAMEBANK_MIN_ACCOUNT_CREATION_FEE );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = GAMEBANK_MIN_BLOCK_SIZE_LIMIT * 2;
      uint16_t          gbd_interest_rate  = GAMEBANK_DEFAULT_GBD_INTEREST_RATE;
      ...
      void validate()const
      {
         ...
         FC_ASSERT( account_creation_fee.amount >= GAMEBANK_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= GAMEBANK_MIN_BLOCK_SIZE_LIMIT);
         FC_ASSERT( gbd_interest_rate >= 0 );
         FC_ASSERT( gbd_interest_rate <= GAMEBANK_100_PERCENT );
      }
   };
   ...
   struct witness_set_properties_operation : public base_operation
   {
      ...
      void get_required_authorities( vector< authority >& a )const
      {
         ...
         if( key_itr != props.end() )
         {
            ...
            a.push_back( authority( 1, GAMEBANK_NULL_ACCOUNT, 1 ) ); // The null account auth is impossible to satisfy
      }
   };
    ...
    *  used to define the exchange rate between gbc and the dollar.
    */
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between GBC and GBD,
    *  The funds are deposited after GAMEBANK_CONVERSION_DELAY
    */
    ...
    * GAMEBANK_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting gbc.
    *
    * The result of the operation is to transfer the full VESTING GBC balance
    ...
    * of GBS from voting on the same content twice.
    */
   ...
   struct crowdfunding_operation : public base_operation
   {
       ...
       void get_required_posting_authorities(flat_set< account_name_type >& a) const { a.insert(originator); }
       void validate() const;
   };

   struct invest_operation : public base_operation
   {
       ...
       void get_required_posting_authorities(flat_set< account_name_type >& a) const { a.insert(invester); }
       void validate() const;
   };
   
   struct nonfungible_fund_create_operation : public base_operation
   {
	   account_name_type	creator;
	   account_name_type	owner;

	   string				meta_data;
	   //shared_string     creator_sign;

	   void get_required_posting_authorities(flat_set<account_name_type>& a)const { a.insert(creator); }
	   void validate()const;
   };

   struct nonfungible_fund_transfer_operation : public base_operation
   {
	   account_name_type from;
	   account_name_type to;
   ...
   /**
    * Puts up nonfungible fund into market for sale.
    */
   struct nonfungible_fund_put_up_for_sale_operation : public base_operation
   {
      ...
      void  validate()const;
      void  get_required_active_authorities( flat_set<account_name_type>& a )const{ a.insert(seller); }

      asset get_price()const { return selling_price; }
   };

   /**
    *  Withdraws the nonfungible fund from sale.
    */
   struct nonfungible_fund_withdraw_from_sale_operation : public base_operation
   {
      account_name_type  seller;
      int64_t            fund_id;
    ...
    *	buys
    */
   struct nonfungible_fund_buy_operation : public base_operation
   {
...
FC_REFLECT( gamebank::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( gamebank::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( gamebank::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( gamebank::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( gamebank::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( gamebank::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( gamebank::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( gamebank::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( gamebank::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( gamebank::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( gamebank::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( gamebank::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( gamebank::protocol::legacy_chain_properties,
            (account_creation_fee)
            (maximum_block_size)
            (gbd_interest_rate)
          )

FC_REFLECT_TYPENAME( gamebank::protocol::pow2_work )
FC_REFLECT( gamebank::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( gamebank::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( gamebank::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( gamebank::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( gamebank::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( gamebank::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( gamebank::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( gamebank::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( gamebank::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( gamebank::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( gamebank::protocol::witness_set_properties_operation, (owner)(props)(extensions) )
FC_REFLECT( gamebank::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( gamebank::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( gamebank::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( gamebank::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( gamebank::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( gamebank::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( gamebank::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( gamebank::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( gamebank::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( gamebank::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( gamebank::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( gamebank::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( gamebank::protocol::comment_payout_beneficiaries, (beneficiaries) )


FC_REFLECT_TYPENAME( gamebank::protocol::comment_options_extension )
FC_REFLECT( gamebank::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_gamebank_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( gamebank::protocol::escrow_transfer_operation, (from)(to)(gbd_amount)(gbc_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( gamebank::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( gamebank::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( gamebank::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(gbd_amount)(gbc_amount) );
FC_REFLECT( gamebank::protocol::claim_account_operation, (creator)(fee)(extensions) );
FC_REFLECT( gamebank::protocol::create_claimed_account_operation, (creator)(new_account_name)(owner)(active)(posting)(memo_key)(json_metadata)(extensions) );
FC_REFLECT( gamebank::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( gamebank::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( gamebank::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( gamebank::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( gamebank::protocol::claim_reward_balance_operation, (account)(reward_gbc)(reward_gbd)(reward_vests) )

FC_REFLECT( gamebank::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
FC_REFLECT( gamebank::protocol::crowdfunding_operation, (originator)(permlink)(raise)(title)(body)(json_metadata) );
FC_REFLECT( gamebank::protocol::invest_operation, (invester)(originator)(permlink)(raise) );
FC_REFLECT( gamebank::protocol::nonfungible_fund_create_operation, (creator)(owner)(meta_data) );
FC_REFLECT( gamebank::protocol::nonfungible_fund_transfer_operation, (from)(to)(fund_id) );
