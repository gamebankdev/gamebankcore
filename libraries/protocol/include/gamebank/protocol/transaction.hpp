...
namespace gamebank { namespace protocol {
   ...
   struct transaction
   {
      ...
      fc::time_point_sec expiration;	//	交易的失效期
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = GAMEBANK_MAX_SIG_CHECK_DEPTH
         )const;
      ...
      void verify_authority(
         ...
         const authority_getter& get_owner,
         const authority_getter& get_posting,
         uint32_t max_recursion = GAMEBANK_MAX_SIG_CHECK_DEPTH )const;
...
FC_REFLECT( gamebank::protocol::contract_transaction, (ref_block_num)(ref_block_prefix)(operations) )
