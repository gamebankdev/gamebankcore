...
namespace gamebank { namespace protocol {
   ...
   struct author_reward_operation : public virtual_operation {
      ...
      author_reward_operation( const account_name_type& a, const string& p, const asset& s, const asset& st, const asset& v )
         :author(a), permlink(p), gbd_payout(s), gbc_payout(st), vesting_payout(v){}
   ...
   {
      interest_operation( const string& o = "", const asset& i = asset(0,GBD_SYMBOL) )
         :owner(o),interest(i){}
...
FC_REFLECT( gamebank::protocol::curation_reward_operation, (curator)(reward)(comment_author)(comment_permlink) )
FC_REFLECT( gamebank::protocol::comment_reward_operation, (author)(permlink)(payout) )
FC_REFLECT( gamebank::protocol::fill_convert_request_operation, (owner)(requestid)(amount_in)(amount_out) )
FC_REFLECT( gamebank::protocol::liquidity_reward_operation, (owner)(payout) )
FC_REFLECT( gamebank::protocol::interest_operation, (owner)(interest) )
FC_REFLECT( gamebank::protocol::fill_vesting_withdraw_operation, (from_account)(to_account)(withdrawn)(deposited) )
FC_REFLECT( gamebank::protocol::shutdown_witness_operation, (owner) )
FC_REFLECT( gamebank::protocol::fill_order_operation, (current_owner)(current_orderid)(current_pays)(open_owner)(open_orderid)(open_pays) )
FC_REFLECT( gamebank::protocol::fill_transfer_from_savings_operation, (from)(to)(amount)(request_id)(memo) )
FC_REFLECT( gamebank::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( gamebank::protocol::comment_payout_update_operation, (author)(permlink) )
