...
#include <gamebank/protocol/asset_symbol.hpp>
#include <gamebank/protocol/fixed_string.hpp>
...
namespace gamebank {
   ...
   namespace protocol {
      ...
      #define GAMEBANK_INIT_PUBLIC_KEY (gamebank::protocol::public_key_type(GAMEBANK_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const gamebank::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  gamebank::protocol::public_key_type& vo );
    void to_variant( const gamebank::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, gamebank::protocol::extended_public_key_type& vo );
    void to_variant( const gamebank::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, gamebank::protocol::extended_private_key_type& vo );
}

FC_REFLECT( gamebank::protocol::public_key_type, (key_data) )
FC_REFLECT( gamebank::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( gamebank::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( gamebank::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( gamebank::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( gamebank::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( gamebank::protocol::share_type )

FC_REFLECT( gamebank::void_t, )
